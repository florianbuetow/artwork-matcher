...
class TestSettings:
    ...
    def test_valid_config_creates_settings(self) -> None:
        ...
        config = {
            ...
            "preprocessing": {"image_size": 518, "normalize": True},
    ...
    def test_invalid_device_literal_raises_error(self) -> None:
        """Invalid device value raises ValidationError."""
        config = {
            "service": {"name": "test", "version": "1.0.0"},
            "model": {
                "name": "facebook/dinov2-base",
                "device": "invalid_device",  # Not in Literal["auto", "cpu", "cuda", "mps"]
                "embedding_dimension": 768,
                "cache_dir": ".cache",
                "revision": "main",
            },
